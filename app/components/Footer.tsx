export default function Footer() {
  return (
    <footer className="md:fixed md:bottom-0 md:left-0 md:right-0 bg-white dark:bg-gray-950 z-10">
      <div className="max-w-4xl mx-auto px-6 py-8 border-t border-gray-200 dark:border-gray-800">
        <div className="flex justify-center">
          <div className="flex items-center space-x-6">
            ...
            <a
              href="https://linkedin.com/in/singhalkarun"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-600 hover:text-gray-900 transition-colors duration-200"
            >
            ...
            <a
              href="https://singhalkarun.medium.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-600 hover:text-gray-900 transition-colors duration-200"
            >
              <svg className="w-6 h-6" viewBox="0 0 1024 1024" fill="none">
                <rect width="1024" height="1024" rx="179.649" fill="currentColor"/>
